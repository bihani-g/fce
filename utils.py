...
import nltk
nltk.download('wordnet'); nltk.download('averaged_perceptron_tagger'); nltk.download('stopwords')
...
def create_data_split(data, size, ds_name):    
    ...
    data_n.save_to_disk(data_path+"/"+ds_name+str(size)+".hf")
...
class finetuning_data(LightningDataModule):
    ...
    def __init__(
        ...
        data_path: str = "./conf_data",
        data_dir: str = "news1000.hf",
        data_name: str = "news",
    ...
    def setup(self, stage: str):
        self.original_dataset = datasets.load_from_disk(os.path.join(self.data_path, self.data_dir))
    ...
    def prepare_data(self):
        datasets.load_from_disk(os.path.join(self.data_path, self.data_dir))
